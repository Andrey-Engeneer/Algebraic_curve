...
int main()
{
	...
	while (true)
	{
		...
		cout << "1-вычисление координат точки на кривой по заданному параметру;" << endl 
			<< "2-вычисление касательного вектора к кривой по заданному параметру" << endl 
			<< "3-выдача информации, является ли данная кривая замкнутой" << endl;
